...
def DEMA(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def EMA(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def HT_TRENDLINE(real: NDArray[np.float64]) -> NDArray[np.float64]: ...
def KAMA(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def MA(
    real: NDArray[np.float64], timeperiod: int = 30, matype: MA_Type = MA_Type.SMA
) -> NDArray[np.float64]: ...
def MAMA(
    real: NDArray[np.float64], fastlimit: float = 0, slowlimit: float = 0
...
def MIDPOINT(
    real: NDArray[np.float64], timeperiod: int = 14
) -> NDArray[np.float64]: ...
def MIDPRICE(
    high: NDArray[np.float64], low: NDArray[np.float64], timeperiod: int = 14
) -> NDArray[np.float64]: ...
def SAR(
...
def T3(
    real: NDArray[np.float64], timeperiod: int = 5, vfactor: float = 0
) -> NDArray[np.float64]: ...
def TEMA(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def TRIMA(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def WMA(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
...
def CMO(real: NDArray[np.float64], timeperiod: int = 14) -> NDArray[np.float64]: ...
def DX(
    high: NDArray[np.float64],
    low: NDArray[np.float64],
    close: NDArray[np.float64],
...
def MACDFIX(
    real: NDArray[np.float64], signalperiod: int = 9
) -> Tuple[NDArray[np.float64], NDArray[np.float64], NDArray[np.float64]]: ...
def MFI(
    high: NDArray[np.float64],
    low: NDArray[np.float64],
...
def MOM(real: NDArray[np.float64], timeperiod: int = 10) -> NDArray[np.float64]: ...
def PLUS_DI(
    high: NDArray[np.float64],
    low: NDArray[np.float64],
    close: NDArray[np.float64],
...
def ROC(real: NDArray[np.float64], timeperiod: int = 10) -> NDArray[np.float64]: ...
def ROCP(real: NDArray[np.float64], timeperiod: int = 10) -> NDArray[np.float64]: ...
def ROCR(real: NDArray[np.float64], timeperiod: int = 10) -> NDArray[np.float64]: ...
def ROCR100(real: NDArray[np.float64], timeperiod: int = 10) -> NDArray[np.float64]: ...
...
def TRIX(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def ULTOSC(
    high: NDArray[np.float64],
    low: NDArray[np.float64],
    close: NDArray[np.float64],
...
def BETA(
    real0: NDArray[np.float64], real1: NDArray[np.float64], timeperiod: int = 5
) -> NDArray[np.float64]: ...
def CORREL(
    real0: NDArray[np.float64], real1: NDArray[np.float64], timeperiod: int = 30
) -> NDArray[np.float64]: ...
def LINEARREG(
    real: NDArray[np.float64], timeperiod: int = 14
) -> NDArray[np.float64]: ...
...
def STDDEV(
    real: NDArray[np.float64], timeperiod: int = 5, nbdev: float = 1
) -> NDArray[np.float64]: ...
def TSF(real: NDArray[np.float64], timeperiod: int = 14) -> NDArray[np.float64]: ...
def VAR(
    real: NDArray[np.float64], timeperiod: int = 5, nbdev: float = 1
) -> NDArray[np.float64]: ...
...
def ADD(
    real0: NDArray[np.float64], real1: NDArray[np.float64]
) -> NDArray[np.float64]: ...
def DIV(
    real0: NDArray[np.float64], real1: NDArray[np.float64]
) -> NDArray[np.float64]: ...
def MAX(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def MAXINDEX(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.int32]: ...
def MIN(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def MININDEX(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.int32]: ...
def MINMAX(
    real: NDArray[np.float64], timeperiod: int = 30
) -> Tuple[NDArray[np.float64], NDArray[np.float64]]: ...
def MINMAXINDEX(
    real: NDArray[np.float64], timeperiod: int = 30
) -> Tuple[NDArray[np.float64], NDArray[np.float64]]: ...
...
def SUM(real: NDArray[np.float64], timeperiod: int = 30) -> NDArray[np.float64]: ...
def ACCBANDS(
    high: NDArray[np.float64],
    low: NDArray[np.float64],
    close: NDArray[np.float64],
...
def AVGDEV(real: NDArray[np.float64], timeperiod: int = 14) -> NDArray[np.float64]: ...
def IMI(
    open: NDArray[np.float64], close: NDArray[np.float64], timeperiod: int = 14
) -> NDArray[np.float64]: ...
...
def stream_MOM(
    real: NDArray[np.float64], timeperiod: int = 10
) -> NDArray[np.float64]: ...
def stream_PLUS_DI(
    high: NDArray[np.float64],
    low: NDArray[np.float64],
